...
const allMembers: Member[] = [
  ...
  },
  {
    ...
    introParagraphs: [
      ...
      'テクノロジーによって開発が加速する今だからこそ、私は「AIと人間の適材適所な共創」を大切にしています。AIの可能性を活かしながら、核心部には人間が持つ「泥臭い追求心」や「執着に似たこだわり」を注ぎ込む。その両方が重なったとき、デザインは単なる装飾を超え、想像以上の景色へ連れて行ってくれると確信しているからです。',
