      ...
      qa: [
        {
          ...
          a: 'A)僕自身が美容師として働く中で、「日本の男性の美意識を底上げし、日本国民をカッコ良くする」という想いがずっとありました。ただ、一人をカッコ良くするだけでは限界があります。既存の予約媒体では難しい部分もあり、美容師個人がもっと活躍できる形を作らない限り、本当の意味で国民の底上げにはつながらないと感じていました。そこで、新しい形で男性の美容意識を高められるサービスとして、Men’teの構想を考え始めました。',
        },
        {
          q: 'Q)開発を進めるうえで、どのような不安がありましたか？',
          a: 'A)アプリ開発自体が完全に未経験だったので、「何をどう進めればいいのか分からない」「本当に形になるのか」という不安は常にありました。特に、自分の頭の中にはイメージがあるのに、それを開発側に正確に伝える難しさが大きかったです。',
        },
        {
          q: 'Q)以前の開発では、どのような課題がありましたか？',
          a: 'A)以前お願いしていた会社では、かなり大きな金額をかけて開発を進めていました。ただ、途中から「今どこまで進んでいるのか」「何が完成していて、何が未完成なのか」が見えづらくなっていきました。コミュニケーション面でも認識のズレが増え、自分の中では不安がどんどん大きくなっていった印象です。結果として、思い描いていた形にはならず、精神的にもかなりしんどい時期でした。',
        },
        {
          q: 'Q)一度うまくいかなかった中で、改めて開発を依頼しようと思えた理由は何でしたか？',
          a: 'A)正直、一度失敗を経験していたので、「また同じことになるんじゃないか」という怖さはかなりありました。それでも再挑戦しようと思えたのは、Men’teを諦めきれなかったからです。美容業界で実際に働いているからこそ、このサービスには需要があると思っていました。御社を選んだ理由は、単純に信頼ができたからです。ただ作るだけではなく、「なぜ必要なのか」「どういう使われ方をするのか」を一緒に整理しながら進めてくれた感覚がありました。過去の失敗も親身に相談に乗ってくれて、ここなら信頼できるという確信を持てました。',
        },
        {
          q: 'Q)開発が始まってからの進め方はどう感じましたか？',
          a: 'A)以前の開発資料がそのまま使えない部分も多かったので、かなりゼロベースに近い状態から要件を整理していく必要がありました。その中でも、細かく確認しながら進めてもらえたので、「今どこを作っているのか」「次に何を決めるべきか」が以前よりかなり見えやすかったです。アプリ開発は専門用語も多く、経営者側が理解しきれない部分もありますが、その都度すり合わせをしながら進めてもらえた点は安心感がありました。',
        },
        {
          q: 'Q)リリース後のサポートについては、どのように感じていますか？',
          a: 'A)リリースして終わりではなく、運用が始まってからの対応がすごく大事だと思っています。実際、使い始めると細かい改善点や不具合は必ず出てきます。その時に相談できる状態があるのは、とても感謝しています。アプリは運営しながら育てていくものだと思っているので、継続的に相談できる環境があるのは本当に助かっています。',
        },
        {
          q: 'Q)弊社に依頼した後、状況はどう変わりましたか？',
          a: 'A)以前は、「本当に完成するのか分からない」という不安の方が強かったです。今は、もちろん課題はまだまだありますが、前に進んでいる感覚があります。実際にユーザー登録や利用も始まり、頭の中の構想だったものが、少しずつサービスとして形になってきています。期待というより、「やっとスタート地点に立てた」という感覚が近いかもしれません。',
        },
        {
          q: 'Q)同じような悩みを持つ経営者の方に勧めるとしたら、弊社をどのように伝えますか？',
          a: 'A)「開発だけをする会社」ではなく、「一緒に整理しながら共に進んでくれる会社」と伝えると思います。特に、アプリ開発が初めての経営者は、不安や分からないことがかなり多いです。その時に、一方的ではなくコミュニケーションを取りながら進めてくれるかはかなり重要だと思います。',
        },
        {
          q: 'Q)今後、弊社に期待していることはありますか？',
          a: 'A)Men’teはまだこれからのサービスなので、今後も改善や機能追加はかなり増えていくと思っています。なので、単発の開発だけではなく、「一緒にサービスを育てていくパートナー」として、引き続き相談しながら進めていけたら嬉しいです。',
        },
      ],
    },
    { type: 'divider', gap: 200 },
